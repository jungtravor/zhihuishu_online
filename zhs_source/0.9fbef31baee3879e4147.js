webpackJsonp([0], Array(579).concat([function(t, e, i) {
	...
	function a(t, e, i) {
		...
		et(jt, n), et(Wt, n), this._scheduler = new xt(this, r, Wt, jt), it.call(this, this._ecEventProcessor = new C), this._messageCenter = new o, this._initEvents(), this.resize = K.bind(this.resize, this), this._pendingActions = [], a.animation.on("frame", this._onframe, this), f(a, this), K.setAsPrimitive(this)
	}
	...
	function c(t, e) {
		...
		var c = [t],
			u = !1;
		t.batch && (u = !0, c = K.map(t.batch, function(e) {
		...
		if (tt.canvasSupported) {
			...
			if ($t[e]) {
				var o = 1 / 0,
					...
					l = [],
					d = t && t.pixelRatio || 1;
				K.each(Yt, function(d, c) {
					if (d.group === e) {
						var u = d.getRenderedCanvas(K.clone(t)),
	...
	function n(t, e, i, n) {
		return i = i || {}, n || !p.canvasSupported ? o(t, e, i) : p.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (i.zrX = e.layerX, i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX, i.zrY = e.offsetY) : o(t, e, i), i
	}

	function o(t, e, i) {
		if (t.getBoundingClientRect && p.domSupported) {
			var n = e.clientX,
				o = e.clientY;
			if ("CANVAS" === t.nodeName.toUpperCase()) {
				var s = t.getBoundingClientRect();
				return i.zrX = n - s.left, void(i.zrY = o - s.top)
			}
			var l = t[y] || (t[y] = {}),
				d = r(a(t, l), l);
			if (d) return d(x, n, o), i.zrX = x[0], void(i.zrY = x[1])
		}
		i.zrX = i.zrY = 0
	}
	...
	function a(t, e) {
		...
		for (var n = ["left", "right"], o = ["top", "bottom"], a = 0; a < 4; a++) {
			var r = document.createElement("div"),
				...
				l = a % 2,
				d = (a >> 1) % 2;
			s.cssText = ["position:absolute", "visibility: hidden", "padding: 0", "margin: 0", "border-width: 0", "width:0", "height:0", n[l] + ":0", o[d] + ":0", n[1 - l] + ":auto", o[1 - d] + ":auto", ""].join("!important;"), t.appendChild(r), i.push(r)
		}
		return i
	}

	function r(t, e) {
		for (var i = e.transformer, n = e.srcCoords, o = !0, a = [], r = [], s = 0; s < 4; s++) {
			var l = t[s].getBoundingClientRect(),
				d = 2 * s,
				c = l.left,
				u = l.top;
			a.push(c, u), o &= n && c === n[d] && u === n[d + 1], r.push(t[s].offsetLeft, t[s].offsetTop)
		}
		return o ? i : (e.srcCoords = a, e.transformer = v(a, r))
	}
	...
	function l(t, e, i) {
		if (e = s(e), null != e.zrX) return e;
		var o = e.type;
		if (o && o.indexOf("touch") >= 0) {
			var a = "touchend" !== o ? e.targetTouches[0] : e.changedTouches[0];
			a && n(t, a, e, i)
		} else n(t, e, e, i), e.zrDelta = e.wheelDelta ? e.wheelDelta / 120 : -(e.detail || 0) / 3;
		var r = e.button;
		return null == e.which && void 0 !== r && _.test(e.type) && (e.which = 1 & r ? 1 : 2 & r ? 3 : 4 & r ? 2 : 0), e
	}

	function d(t, e, i, n) {
		m ? t.addEventListener(e, i, n) : t.attachEvent("on" + e, i)
	}

	function c(t, e, i, n) {
		m ? t.removeEventListener(e, i, n) : t.detachEvent("on" + e, i)
	}
	...
	var p = i(587),
		g = i(854),
		v = g.buildTransformer,
		m = "undefined" != typeof window && !!window.addEventListener,
	...
	e.clientToLocal = n, e.getNativeEvent = s, e.normalizeEvent = l, e.addEventListener = d, e.removeEventListener = c, e.stop = b, e.isMiddleOrRightButtonOnMouseUpDown = u, e.notLeftMouse = h
}, function(t, e, i) {
	function n(t) {
		t = t || {}, r.call(this, t);
	...
	function i(t, e, i) {
		...
		if (e && n) {
			var r = e.x1,
				...
				l = e.y1,
				d = e.y2;
			a(2 * r) === a(2 * s) ? t.x1 = t.x2 = o(r, n, !0) : (t.x1 = r, t.x2 = s), a(2 * l) === a(2 * d) ? t.y1 = t.y2 = o(l, n, !0) : (t.y1 = l, t.y2 = d)
		}
	}
	...
	function n(t, e, i) {
		...
		if (e && n) {
			var a = e.x,
				...
				s = e.width,
				l = e.height;
			t.x = o(a, n, !0), t.y = o(r, n, !0), t.width = Math.max(o(a + s, n, !1) - t.x, 0 === s ? 0 : 1), t.height = Math.max(o(r + l, n, !1) - t.y, 0 === l ? 0 : 1)
		}
	}
	...
	function r(t, e, i, n, o, a) {
		...
		if (K && (Z && (e.lineWidth = Y), Q && (e.strokeStyle = K)), J && (l && n.textFill === r.textFill || (e.fillStyle = J)), 1 === S.length) K && e.strokeText(S[0], z, N), J && e.fillText(S[0], z, N);
			...
			for (var q = 0; q < S.length; q++) K && e.strokeText(S[q], z, N), J && e.fillText(S[q], z, N), N += C
	}
	...
	}, e.version = "4.2.0", e.init = n, e.dispose = o, e.getInstance = a, e.registerPainter = r
}, , function(t, e, i) {
	"use strict";
	var n = {
	...
	i.n(s), e.default = {
		...
		mounted: function() {
			...
			(i.i(o.e)(t) || t != "broswer_tip_" + this.userId) && (this.exploreTip = !0), this.identifyCode = "", this.makeCode(this.identifyCodes, 4)
		},
		created: function() {
			var t = this,
		...
		methods: {
			...
			broswerClick: function() {
				this.exploreTip = !1, i.i(o.g)("exploreTipKey", "broswer_tip_" + this.userId, .125);
		...
		methods: {
			habitWarn: function() {
				...
				!this.data.hasHabbitScore || "false" != e && e || (this.habitTime = i.i(c.a)("habitTimeKey") ? i.i(c.a)("habitTimeKey") : 0, this.habitTimer = setInterval(function() {
					t.habitTime++, console.log("时间累积：" + t.habitTime), 60 == t.habitTime && (h.a.currentSystemTime({}).then(function(t) {
						0 == t.code && (console.log("存入cookie"), i.i(c.d)("isHabitTime", "true", t.data))
			...
			heightCompute: function() {
				...
				i.i(c.e)(o) || o != "broswer_tip_" + a ? (e.style.height = n - 113 + "px", t.style.height = n - 313 + "px") : (e.style.height = n - 60 + "px", t.style.height = n - 260 + "px")
			},
			goBack: function() {
				var t = this.lessonId,
					e = this.smallLessonId,
					n = [this.recruitId, t, e, this.lastViewVideoId, 1, this.data.studyStatus, parseInt(this.playTimes), parseInt(this.totalStudyTime), i.i(c.f)(ablePlayerX("container").getPosition())],
				...
				1 != this.data.studyStatus && i.i(c.g)("saveDataKey", r()(a))
			},
			...
			blackChangeWhite: function() {
				...
				i.i(c.e)(t) || n != t ? this.isBlack = !1 : this.isBlack = "false" != e
			},
			startShowWarn: function() {
				var t = i.i(c.a)("warnKey"),
					e = "warn_" + JSON.parse(i.i(c.a)("CASLOGC")).userId;
				(i.i(c.e)(t) || e != t) && (this.warnDialog = !0)
			},
			warnClick: function() {
				i.i(c.g)("warnKey", "warn_" + JSON.parse(i.i(c.a)("CASLOGC")).userId), this.warnDialog = !1
			},
			startShowRead: function() {
				var t = i.i(c.a)("readKey"),
					e = "read_" + this.recruitId;
				(i.i(c.e)(t) || e != t) && (this.readDialog = !0, this.studyBefore())
			},
			readCloseClick: function() {
				i.i(c.g)("readKey", "read_" + this.recruitId), this.readDialog = !1
			},
			readClick: function() {
			...
			isBlackFun: function() {
				this.isBlack = !this.isBlack, i.i(c.g)("blackToWhiteKey", "black_white_" + JSON.parse(i.i(c.a)("CASLOGC")).userId), i.i(c.g)("blackToWhiteKey2", this.isBlack)
			},
				...
				h.a.getVideoList({
					...
					0 == e.code ? (e.data.videoChapterDtos.map(function(t) {
						...
						e.orderNumberTit = m.a.encodeS(e.orderNumber), e.videoLessons && e.videoLessons.map(function(e, n) {
							t.lessonIds.push(e.id), e.videoId && t.videoIds.push(e.videoId), e.videoSecShow = i.i(c.f)(e.videoSec), e.ishaveChildrenLesson > 0 && e.videoSmallLessons && e.videoSmallLessons.length > 0 && e.videoSmallLessons.map(function(e, n) {
								t.lessonVideoIds.push(e.id), t.videoIds.push(e.videoId), e.name = e.name ? e.name : "暂无小节名称", e.videoSecShow = i.i(c.f)(e.videoSec)
							})
						})
			...
			getqueryCourse: function() {
				...
				i.i(c.e)(e) || (e = JSON.parse(e), e.userId == n && (delete e.userId, h.a.saveDatabaseIntervalTime(e).then(function(e) {
					...
					0 == e.code ? (t.data = e.data, t.videoData = e.data.courseInfo, t.courseId = e.data.courseInfo.courseId, t.recruitId = e.data.recruitId, t.schoolId = e.data.schoolId ? e.data.schoolId : 0, t.blackChangeWhite(), t.startShowWarn(), t.startShowRead(), 1 == e.data.studyStatus ? (t.tipsDialog = !0, t.tipsMsg = "学习时间已经结束, 观看视频将不再计进度 请知晓", t.tipsBtn = "我知道了") : t.schoolId && t.aberrantFun()) : -3 == e.code ? t.$message({
						message: e.message,
						customClass: "error",
						iconClass: "iconfont zhihuishu-icon_toast_cross"
			...
			outlineClick: function() {
				this.teachDialog = !0, this.outline()
			},
			outline: function() {
				var t = this;
				h.a.outline({
				...
				this.smallLessonId || delete n.lessonVideoId, 1 == t.testType ? h.a.lessonPopupExam(n).then(function(t) {
					ablePlayerX("container").pause(), 0 == t.code ? t.data.lessonTestQuestionUseInterfaceDtos && (t.data.lessonTestQuestionUseInterfaceDtos.map(function(t) {
						t.imagList = t.datas && t.datas.filter(function(t) {
							return 2 == t.dataType
						}), t.answerUs = [], t.answerRight = [], t.isError = !0, t.zAnswer ? (t.showAnswer = !0, t.isCheck = !0, t.answerStu = t.zAnswer.answer.split(",")) : (t.showAnswer = !1, t.isCheck = !1, t.answerStu = []), t.testQuestion.questionOptions.map(function(e) {
						...
						}), t.answerRight.join(",") === t.answerStu.join(",") && (t.isError = !1)
					}), e.topicInfo = t.data, e.pageList = e.topicInfo.lessonTestQuestionUseInterfaceDtos[0], e.testDialog = !0, clearInterval(e.habitTimer)) : 403 == t.code && setTimeout(function() {
						window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
					}, 3e3)
				}) : 2 == t.testType ? (ablePlayerX("container").pause(), this.imgUrlDialog = t.url, this.imgDialog = !0) : 3 == t.testType ? t.visible = !t.visible : 4 == t.testType && (t.visible = !t.visible)
			},
			closeImg: function() {
				this.imgDialog = !1
			},
			...
			topicClick: function(t) {
				...
				this.topicInfo.lessonTestQuestionUseInterfaceDtos.map(function(i) {
					if (i.answerStu = [], i.testQuestion.questionId == e.pageList.testQuestion.questionId) {
						if (i.isCheck = !0, i.showAnswer = !0, "radio" == i.testQuestion.questionType.inputType) i.testQuestion.questionOptions.map(function(e) {
						...
						i.answerStu.length <= 0 ? i.isCheck = !1 : i.isCheck = !0, i.isError = !0, e.answerStu = i.answerStu, i.answerStu.join(",") == i.answerRight.join(",") && (i.isError = !1)
					}
				}), i = {
					courseId: this.courseId,
					recruitId: this.recruitId,
			...
			initVideo: function(t) {
				...
				$("#container").Ableplayer({
					...
					onPlay: function() {
						console.log("播放"), i.i(c.e)(e.totalStudyTimeInterval) && 1 != e.data.studyStatus && e.startTotalTimer()
					},
					onTime: function(t) {
			...
			saveCacheIntervalTime: function() {
				var t = this,
					e = [this.recruitId, this.videoDetail.chapterId, this.courseId, this.lessonId, i.i(c.f)(ablePlayerX("container").getPosition()), parseInt(this.totalStudyTime), this.lastViewVideoId, this.smallLessonId, parseInt(this.playTimes)],
					n = {
				...
				console.log("提交进度时间:" + this.playTimes), console.log("观看总时间:" + this.totalStudyTime), h.a.saveCacheIntervalTime(n).then(function(e) {
					t.playTimes = 0, t.watchPointPost = "", -10 == e.code ? (t.tipsDialog = !0, t.tipsMsg = "同时播放多个视频，其他页面的学习进度将停止记录哦！", t.tipsBtn = "我知道了") : 403 == e.code && setTimeout(function() {
						window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
					}, 3e3)
				})
			},
			saveDatabaseIntervalTime: function(t, e, n) {
				var o = this,
					...
					s = [this.recruitId, a, r, this.lastViewVideoId, 1, this.data.studyStatus, parseInt(this.playTimes), parseInt(this.totalStudyTime), i.i(c.f)(ablePlayerX("container").getPosition())],
					l = {
						ev: this.D26666.Z(s),
						learningTokenId: y.encode(this.preVideoInfo.studiedLessonDto.id)
					};
				console.log("提交进度时间:" + this.playTimes), console.log("观看总时间:" + this.totalStudyTime), h.a.saveDatabaseIntervalTime(l).then(function(i) {
					o.playTimes = 0, -10 == i.code ? (o.tipsDialog = !0, o.tipsMsg = "同时播放多个视频，其他页面的学习进度将停止记录哦！", o.tipsBtn = "我知道了") : 403 == i.code ? setTimeout(function() {
						window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
					}, 3e3) : o.saveDataFilish && t && (o.prelearningNote(t, e, n), o.saveDataFilish = !1)
				})
			},
	...
	d.updateData = function(t, e, i) {
		...
		g && n.attr("cursor", g), o(this, t.getItemLayout(e), d.isSelected(null, e), d.get("selectedOffset"), d.get("animation"));
			...
			for (var v = e.mapDimension(f.dim), m = e.mapDimension(r.dim), _ = y(e, v), x = f.isHorizontal(), b = p(r, f, _), w = 0, S = e.count(); w < S; w++) {
				...
				if (!isNaN(C) && !isNaN(k)) {
					...
					if (x) {
						...
						D = T, M = P[1] + u, A = P[0] - b, L = h, Math.abs(A) < g && (A = (A < 0 ? -1 : 1) * g), _ && (s[l][k][I] += A)
					} else {
						var P = i.dataToPoint([k, C]);
						D = P[0] + u, M = T, A = h, L = P[1] - b, Math.abs(L) < g && (L = (L <= 0 ? -1 : 1) * g), _ && (s[l][k][I] += L)
					}
					e.setItemLayout(w, {
						x: D,
						y: M,
	...
	var g = i(580),
		...
		S = {
			...
			reset: function(t) {
				function e(t, e) {
					for (var i, l = t.count, c = new w(2 * l), h = new w(l), f = [], v = [], m = 0, _ = 0; null != (i = t.next());) v[u] = e.get(r, i), v[1 - u] = e.get(s, i), f = n.dataToPoint(v, null, f), c[m++] = f[0], c[m++] = f[1], h[_++] = i;
					e.setLayout({
						largePoints: c,
						largeDataIndices: h,
						barWidth: g,
						valueAxisStart: p(o, a, !1),
	...
	t.exports = {
		render: function() {
			...
			return i("div", {
				...
				attrs: {
					target: "_blank",
					href: "//wenda.zhihuishu.com/shareCourse/qaAnswerIndexPage?sourceType=2&selectCourseId=" + t.courseId + "&courseId=" + t.courseId + "&recruitId=" + t.recruitId
				}
			}, [t.isBlack ? i("svg", {
				staticClass: "icon",
				attrs: {
			...
			})]), t._v(" "), i("div", [t._v("课程问答")])])]), t._v(" "), i("li", {
			...
			})]), t._v(" "), i("div", [t._v("课程表")])])]), t._v(" "), 2 != t.videoData.type ? i("li", {
			...
			}, [t.pageList.isCheck ? i("span", [t.pageList.isError ? i("span", {
				staticClass: "error"
			}, [i("i", {
				staticClass: "iconfont iconcuowu1"
			}), t._v("\n                                    错误\n                                ")]) : t._e(), t._v(" "), t.pageList.isError ? t._e() : i("span", {
				staticClass: "right"
			}, [i("i", {
			...
			}, [t._v("超过学习时间，学习不记进度、作业停止提交、见面课回放不记签到。")]), t._v(" "), i("div", {
				...
				attrs: {
					src: "//image.zhihuishu.com/zhs_yufa_150820/ablecommons/demo/201911/95be97b1c6624242a997af4136f87dd8.png",
					width: "570"
				}
			}), t._v(" "), i("img", {
				attrs: {
					src: "//image.zhihuishu.com/zhs_yufa_150820/ablecommons/demo/201912/cd7faa4803ec46b3a2dc7fe26c027fcf.png",
					width: "570"
				}
